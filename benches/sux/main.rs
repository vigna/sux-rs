...
const MAPPING: [(
    ...
    (RankSel::SelectSmall0, bench_select::<SelectSmall<2, 9, u64, _>>),
    (RankSel::SelectSmall1, bench_select::<SelectSmall<1, 9, u64, _>>),
    (RankSel::SelectSmall2, bench_select::<SelectSmall<1, 10, u64, _>>),
    (RankSel::SelectSmall3, bench_select::<SelectSmall<1, 11, u64, _>>),
    (RankSel::SelectSmall4, bench_select::<SelectSmall<3, 13, u64, _>>),
