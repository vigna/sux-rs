...
fn main() {
    ...
    match filter.as_str() {
        ...
        "batch" => {
            bench_rank10sel_1024_11(&mut criterion);
            bench_rank10sel_1024_11_non_uniform(&mut criterion);
            bench_rank10sel_1024_12(&mut criterion);
            bench_rank10sel_1024_12_non_uniform(&mut criterion);
            bench_rank10sel_1024_13(&mut criterion);
            bench_rank10sel_1024_13_non_uniform(&mut criterion);
        }
