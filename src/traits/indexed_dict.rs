...
pub trait IndexedSeq: Types {
    ...
    fn binary_search<'a>(&self, x: Self::Output<'a>) -> Result<usize, usize>
    where
        Self::Output<'a>: Ord,
    {
    ...
    */
    ...
    where
        for<'a> F: FnMut(Self::Output<'a>) -> std::cmp::Ordering,
    {
        use std::cmp::Ordering::*;
        use std::hint;
        // Copied from https://archive.softwareheritage.org/swh:1:cnt:c6206fc99ea68b200b8342cf7ec58fdbe5e3e5c5;origin=https://github.com/rust-lang/rust;visit=swh:1:snp:a3a4227361ea6302c285fbbed9ba1215da993048;anchor=swh:1:rel:ebfd33271586f0dd1bc6fe1016a0c38aae31f88b;path=/library/core/src/slice/mod.rs;lines=2816-2863
        ...
        while size > 1 {
            ...
            // except we can't because it's a compiler intrinsice, so we have to do it
            // the naive way:
