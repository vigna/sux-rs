...
#[test]
fn test_u32_max() {
    let ef = EfList::new(vec![u32::MAX]);
    assert_eq!(ef.index_value(0), u32::MAX);
}

#[test]
fn test_u32_ones() {
    let ef = EfList::new(vec![1u32; 100]);
...
#[test]
fn test_u64_max() {
    let ef = EfList::new(vec![u64::MAX]);
    assert_eq!(ef.index_value(0), u64::MAX);
}

#[test]
fn test_u64_ones() {
    let ef = EfList::new(vec![1u64; 100]);
    assert_eq!(ef.len(), 100);
    for i in 0..100 {
        assert_eq!(ef.index_value(i), 1);
    }
...
#[test]
fn test_u128_max() {
    let ef = EfList::new(vec![u128::MAX]);
    assert_eq!(ef.index_value(0), u128::MAX);
}

#[test]
fn test_u128_ones() {
    let ef = EfList::new(vec![1u128; 100]);
    assert_eq!(ef.len(), 100);
    for i in 0..100 {
        assert_eq!(ef.index_value(i), 1);
    }
