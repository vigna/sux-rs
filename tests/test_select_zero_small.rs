...
fn test_empty() {
    ...
    let select = SelectZeroSmall::<2, 9, _>::new(RankSmall::<2, 9, _>::new(bits.clone()));
...
fn test_ones() {
    ...
    let select = SelectZeroSmall::<2, 9, _>::new(RankSmall::<2, 9, _>::new(bits));
